...
# Configure the legacy database connection
...
config :vutuv, VutuvWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "/IUIzyjsY4o/x6nGTy4y0KFXOVZzCsmnKzdQqnbwQtugDe2l03HXak6Ra2MB18j6",
  watchers: [
...
config :vutuv, VutuvWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/vutuv_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :vutuv, dev_routes: true
